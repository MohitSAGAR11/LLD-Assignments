...
1. `services.EligibilityEngine.evaluate` is a long if/else chain with mixed responsibilities.
...
5. Engine does persistence-ish logging via `repository.FakeEligibilityStore`.
